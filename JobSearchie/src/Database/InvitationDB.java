...
public class InvitationDB implements DBHelper{
    ...
    public InvitationDB(Connection conn) throws SQLException {
        insertInvitation = conn.prepareStatement(Insert.INVITATION, Statement.RETURN_GENERATED_KEYS);
        queryInvitationById = conn.prepareStatement(Query.INVITATION_BY_ID);
        queryAllInvitations = conn.prepareStatement(Query.ALL_INVITATIONS);
    }
