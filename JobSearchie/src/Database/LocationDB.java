...
public class LocationDB implements DBHelper {
    ...
    public LocationDB(Connection conn) throws SQLException {
        queryLocationId = conn.prepareStatement(Query.LOCATION_ID, Statement.RETURN_GENERATED_KEYS);
        queryLocation = conn.prepareStatement(Query.LOCATION, Statement.RETURN_GENERATED_KEYS);
        insertIntoLocation = conn.prepareStatement(Insert.INSERT_LOCATION, Statement.RETURN_GENERATED_KEYS);
    }
