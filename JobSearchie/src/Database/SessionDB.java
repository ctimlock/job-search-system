...
public class SessionDB implements DBHelper{
    ...
    public SessionDB(Connection conn) throws SQLException {
        insertSession = conn.prepareStatement(Insert.SESSION, Statement.RETURN_GENERATED_KEYS);
        updateSession = conn.prepareStatement(Update.SESSION, Statement.RETURN_GENERATED_KEYS);
    }
